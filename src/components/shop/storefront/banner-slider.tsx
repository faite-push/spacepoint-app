...
export function BannerSlider({ 
  ...
  return (
    <div className="w-[100vw] relative left-1/2 -translate-x-1/2 overflow-hidden max-w-[1580px] mx-auto px-4 sm:px-6 lg:px-[2rem] -mt-28 rounded-2xl">
      <div ref={sliderRef} className="keen-slider h-full rounded-xl">
        {banners.map((b) => {
          const imageUrl = resolveMediaUrl(b.imageUrl) || "/placeholder.svg";
          return (
          <div
            key={b.id}
            className="keen-slider__slide flex justify-center shrink-0 w-full min-w-full rounded-xl overflow-hidden relative"
          >
            {b.linkUrl ? (
              <Link href={b.linkUrl} className="block w-full h-auto relative group">
                <Image
                  ...
                  width={2560}
                  height={1080}
                  className="w-full h-auto object-cover pointer-events-none select-none rounded-xl transition-transform duration-500"
                  priority
                />
              ...
              <div className="block w-full h-auto relative group">
                <Image
                  ...
                  width={2560}
                  height={1080}
                  className="w-full h-auto object-cover pointer-events-none select-none rounded-xl"
                  priority
                />
              </div>
            )}
