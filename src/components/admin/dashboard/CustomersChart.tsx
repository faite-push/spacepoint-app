...
interface CustomersChartProps {
  data: Array<{ label: string; unique: number; returning: number }>;
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-white/40">
            Compradores no período: primeira compra vs. quem já tinha comprado antes.
          </p>
        </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Label
                    htmlFor="unique"
                    className="text-xs font-medium text-white/70 group-hover:text-white cursor-pointer select-none"
                  >
                    Clientes únicos
                  </Label>
                </div>
